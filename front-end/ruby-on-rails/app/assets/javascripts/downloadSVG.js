function downloadSVG(plotId, descriptor) {
var doctype = '<?xml version="1.0" standalone="no"?><!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">';
  ...
  function initialize(descriptor) {
    ...
    documents.forEach(function(doc) {
      ...
      var newSources = getSources(doc, styles, plotId);
    ...
    if (SVGSources.length > 1) {
      ...
      download(SVGSources[0], descriptor);
    } else {
  ...
  function getSources(doc, styles, plotId) {
    var svgInfo = [],
        svgs = doc.querySelector("#" + plotId).querySelectorAll("svg");
  ...
  function download(source, descriptor) {
    ...
    a.setAttribute("download", descriptor + "-" + filename + ".svg");
